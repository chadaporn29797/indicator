            ...
            <form method='post' enctype='multipart/form-data' action='<?php echo base_url(); ?>index.php/Main/edit_indicator_only_todb'>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  <input class="form-control" id="indicator_title" name="indicator_title" type="text" value="<?php echo $indicator[0]->indicator_title; ?>" required disabled/>
              ...
              <div class="row">
                <div class="form-group col-md-12">
                  ...
                  <textarea class="form-control" id="description" name="description" rows="2" disabled><?php echo $indicator[0]->description; ?></textarea>
                </div>
              </div>
